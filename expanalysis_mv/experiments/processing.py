...
from expanalysis_mv.experiments.survey_processing import \
    calc_alcohol_pre, calc_alcohol_post,\
    calc_survey_DV, calc_aes_DV, calc_bis11_DV, calc_eating_DV, calc_leisure_time_DV, calc_lon_socsup_pss_pre_DV, calc_lon_socsup_pss_post_DV, \
    calc_lsas_DV, calc_mindset_illness_stress, calc_SSS_DV, calc_SSS_corrlayout_DV, calc_demographics_DV, calc_demographics_covid_DV, \
    calc_crisis_behav_post_DV, calc_crisis_behav_pre_DV, calc_crisis_health_exposure_DV, calc_crisis_life_changes_DV, \
...
def calc_exp_DVs(df, use_check = True, use_group_fun = True, group_kwargs=None):
    ...
    lookup = {'adaptive_n_back': calc_adaptive_n_back_DV,
              ...
              'crisis_behav_emot_media_post_survey__covid': calc_crisis_behav_post_DV,
              'crisis_behav_emot_media_pre_survey__covid': calc_crisis_behav_pre_DV,
              'crisis_health_exposure_survey__covid': calc_crisis_health_exposure_DV,
              'crisis_life_changes_survey__covid': calc_crisis_life_changes_DV,
              ...
              'psychopathology_aes_survey__covid': calc_aes_DV,
              ...
              'mindset_illness_stress_survey__covid' : calc_mindset_illness_stress,
              'alcohol_drugs_survey_pre__covid': calc_alcohol_pre,
              'alcohol_drugs_survey_post__covid': calc_alcohol_post,
              }
